...
pub enum ErrorCode {
    ...
    #[msg("Not the same collection")]
    NOTSAMECOLLECTION,

    #[msg("Mint supply not 1")]
    MINTSUPPLYNOTONE,
    #[msg("Not the same owner")]
    NOTTHESAMEOWNER,
    ...
    NotSameCollectionData,
    #[msg("Invalid length of attribute and data")]
    NotSameAttritubeData,

    #[msg("Failed to match remaining")]
    FailedToMatchRemaining,
    #[msg("Proof havn't init")]
    ProofHavntInit,
    #[msg("Too slow to claim")]
    TooSlowToClaim,
    #[msg("Not in range")]
    NotInRange,
    #[msg("wrong pool owner")]
    WrongPoolOwner,
